...
KNOBS=""
for k in DRAFT_SAMPLE NCCL_TUNED SERVED_NAMES TP BASE PORT MPORT EXP_NAME IMAGE GMU MAXLEN SEQS MAX_BATCHED LONG_PREFILL EAGER CUDAGRAPH_MODE CG_SIZES SPEC SPEC_K SPEC_ADAPT ENGRAM_DISK ENGRAM_LOCAL ENGRAM_THREADS ENGRAM_CHUNK TEXT_ONLY THINKING PARSERS EP RUST_FE PATCH_DIR VLLM_EXTRA NCCL_EXTRA; do
